...
registerFormula({
  ...
  about: [
    ...
    'One point load, constant section, small deflections, elastic material. Self weight is not included, and nor is shear deflection, which starts to tell on beams that are short and deep. There is no factor of safety here and this follows no design code.',
  ],
  eq: 'σmax = Mmax·c / I',
  inputs: [
