...
def head_block(title, description, canonical, trail):
    e = html.escape
    out = [
...
def page(template, title, description, canonical, prerender, trail=None, formula=None):
    ...
    out, n = re.subn(
        ...
        lambda _: head_block(title, description, canonical, trail),
        template, flags=re.S)
    if n != 1:
